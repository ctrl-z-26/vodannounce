  ...
  return (
    <IonPage>
      <IonContent className="login-content" fullscreen>
        <div className="login-container gradient-animated">
          {/* --------------------------------
              BRAND
          -------------------------------- */}
              ...
              */}
              ...
              >
                {loading ? (
                  ...
                  <>
                    <svg width="20" height="20" viewBox="0 0 18 18" fill="none" slot="start" style={{ marginRight: '8px' }}>
                      <path
          ...
          <div className="login-slogan">
            <p>Communicate. Inform. Connect.</p>
          </div>
        </div>
      </IonContent>
    </IonPage>
