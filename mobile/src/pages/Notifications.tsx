...
const initialAnnouncements: Announcement[] = [
  {
    id: "1",
    severity: "critical",
    title: "SAP System Maintenance Window",
    team: "IT Communications",
    teamInitials: "IT",
    date: "Today",
    time: "09:14",
    status: "unread",
  },
  {
    id: "2",
    severity: "important",
    title: "Holiday Policy Update 2025",
    team: "HR Team",
    teamInitials: "HR",
    date: "Yesterday",
    time: "14:30",
  ...
  },
  {
    id: "3",
    severity: "important",
    title: "Security Training Deadline",
    team: "Security Team",
    teamInitials: "ST",
    date: "12 Aug",
    time: "10:00",
        ...
        <div className="notif-list">
          {filtered.map((a) => {
            ...
            return (
              <div
                key={a.id}
                className={`notif-card ${a.severity === "critical" ? "notif-card-critical" : ""}`}
